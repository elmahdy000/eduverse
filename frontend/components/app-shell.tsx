...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { label: "المنتجات", href: "/products", roles: ["Owner", "Operations Manager", "Barista", "Receptionist"], icon: <Package size={14} /> },
      ...
      { label: "المصروفات", href: "/expenses", roles: ["Owner", "Operations Manager", "Receptionist"], icon: <Wallet size={14} /> },
