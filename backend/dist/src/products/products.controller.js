...
let ProductsController = class ProductsController {
    ...
    async listProducts(page = '1', limit = '20', category, availability, active, q) {
        try {
            const result = await this.productsService.listProducts(Number(page), Number(limit), {
                category,
                availability: availability === undefined ? undefined : availability === 'true',
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('availability')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Deactivate product' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Reactivate product' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
