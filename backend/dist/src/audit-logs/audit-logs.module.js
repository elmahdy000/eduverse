...
const audit_logs_interceptor_1 = require("./audit-logs.interceptor");
...
exports.AuditLogsModule = AuditLogsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [audit_logs_service_1.AuditLogsService, audit_logs_interceptor_1.AuditLogsInterceptor],
        exports: [audit_logs_service_1.AuditLogsService, audit_logs_interceptor_1.AuditLogsInterceptor],
    })
], AuditLogsModule);
